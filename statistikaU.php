<?php
//Skripta za ispis statistike ustanova.
...
$tablica1 = "<table id='statistikaU'><thead><tr><th>Ustanova</th><th>Sviđa mi se</th><th>Ne sviđa mi se</th></tr></thead>";

$dnevnikInsert = "insert into Dnevnik values(default,'statistikaU.php','SELECT * FROM Lajkovi;','$vrijeme',$korisnikID,3);";
$baza->updateDB($dnevnikInsert);

$upit3 = "select distinct `Ustanova` from Lajkovi where `Ustanova` is not null;";
...
while ($rez3 = $rezultat3->fetch_array()) {
    ...
    $upit4 = "SELECT sum(`Like`) from Lajkovi where `Ustanova`='$rez3[0]';";
    ...
    $upit5 = "SELECT sum(`Dislike`) from Lajkovi where `Ustanova`='$rez3[0]';";
        ...
        <div id="omotac">
            ...
            <section id="sadrzaj">
                ...
                if ($_SESSION['tip_korisnik'] == 3) {
                    echo "<a class='strana' href='statistikaS.php' style=''></a>";
                }
                ?>
                <?php
                echo $tablica1;
                ...
                <a href="pdf.php?statistikaU=1">PDF</a>
            </section>
        </div>
        <footer id="footer">
            <address>
