...
if (isset($_POST['submit'])) {
    ...
    if (is_uploaded_file($userfile)) {
        if (!move_uploaded_file($userfile, $upfile)) {
            $greska.= 'Problem: Could not move file to destination directory';
            exit;
        }
    } else {
    ...
    if ($userfile_name) {
        ...
        while (($red = fgetcsv($dat, 1000, ";")) !== FALSE) {
            ...
            $upit = "INSERT INTO Poslovnica VALUES ('$red[0]','$red[1]','$red[2]','$red[3]','$red[4]','$red[5]');";
            $baza->updateDB($upit);
        }
        $dnevnikInsert = "insert into Dnevnik values(default,'upload_csvA.php','INSERT INTO Poslovnica;','$vrijeme',$korisnikID,3);";
...
<!DOCTYPE html>
<!--
Skripta za popunjavanje adresa csv datotekom.
Datum:1.6.2016.
-->
<html>
    <head>
    ...
    <body>
        ...
        <div id="omotac">
            ...
            <section id="sadrzaj">
                ...
                <div id="inputForma">
                    <form action="upload_csvA.php" method="post" enctype="multipart/form-data">
