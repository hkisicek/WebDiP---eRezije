<?php
//Skripta za ispis statistike skripata.
...
$dnevnikInsert = "insert into Dnevnik values(default,'statistikaS.php','SELECT * FROM Lajkovi;','$vrijeme',$korisnikID,3);";
$baza->updateDB($dnevnikInsert);

$upit3 = "select distinct `Skripta` from Dnevnik where `Skripta` is not null;";
...
while ($rez3 = $rezultat3->fetch_array()) {
    ...
    $upit4 = "SELECT count(*) from Dnevnik where `Skripta`='$rez3[0]';";
    ...
    <body>
        ...
        <div id="omotac">
            ...
            <section id="sadrzaj">
                ...
                <a href="statistikA.php">Upiti</a>

                <?php
                echo $tablica1;
                ?>
                <a href="javascript:window.print()">Print</a>
                <a href="pdf.php?statistikaS=1">PDF</a>
            </section>
        </div>
        <footer id="footer">
            <address>
